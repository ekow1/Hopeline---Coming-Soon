...
(function(html) {
    ...
    const cfg = {
        ...
        // MailChimp URL
        mailChimpURL : 'https://hopelineinstitute.us17.list-manage.com/subscribe/post?u=7be06caca2b6aa40747a199ee&amp;id=510d15ea07' 
    ...
    * ------------------------------------------------------ */
    const ssCountdown = function () {
        ...
        function timer() {
            ...
            let days = Math.floor( diff/(1000*60*60*24) / 5 );
